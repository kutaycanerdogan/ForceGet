...
public class CountryService : ICountryService
{
    ...
    public async Task<IEnumerable<CountryDto>> GetCountriesBySearchAsync(string countrySearch)
    {
        ...
        try
        {
            //var content = await _apiNinjasService.ResponseFromRequest($"country?name={countrySearch}&limit=5");
            ...
            var countries = doc.RootElement
                ...
                .Select(x => new CountryDto
                {
                    ...
                    CurrencyCode = x.GetProperty("currency").GetProperty("code").GetString()
                })
                .ToList();
